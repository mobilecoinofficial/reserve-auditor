...
//! Convert to/from mc_reserve_auditor_api::Counters.

use crate::db::Counters;

/// Convert Counters --> mc_reserve_auditor_api::Counters
impl From<&Counters> for mc_reserve_auditor_api::Counters {
    fn from(src: &Counters) -> Self {
        let mut dst = mc_reserve_auditor_api::Counters::new();
        ...
        dst.set_num_invalid_ethereum_transactions(src.num_invalid_ethereum_transactions());
        dst.set_num_invalid_multi_sig_transactions(src.num_invalid_multi_sig_transactions());
