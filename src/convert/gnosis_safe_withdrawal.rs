...
//! Convert to/from mc_reserve_auditor_api::GnosisSafeWithdrawal.
...
impl TryFrom<&ProtoGnosisSafeWithdrawal> for DbGnosisSafeWithdrawal {
    ...
    fn try_from(src: &ProtoGnosisSafeWithdrawal) -> Result<Self, Error> {
        ...
        Ok(Self::new(
            ...
            EthAddr::from_str(src.get_to_addr())?,
            src.get_amount(),
...
mod tests {
    ...
    use crate::db::test_utils::{
        ETH_TOKEN_CONTRACT_ADDR, GNOSIS_SAFE_WITHDRAWAL_TO_ADDR, SAFE_ADDR,
    };
