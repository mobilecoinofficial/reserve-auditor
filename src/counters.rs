...
lazy_static::lazy_static! {
    /// Prometheus counters.
    pub static ref OP_COUNTERS: OpMetrics = OpMetrics::new_and_registered("mc_reserve_auditor");
    ...
    pub static ref NUM_INVALID_ETHEREUM_TRANSACTIONS: IntGauge = OP_COUNTERS.gauge("num_invalid_ethereum_transfers");

    /// Number of times we encountered an Ethereum MultiSig transaction that did not have a valid structure.
    pub static ref NUM_INVALID_MULTI_SIG_TRANSACTIONS: IntGauge = OP_COUNTERS.gauge("num_invalid_multi_sig_transactions");
