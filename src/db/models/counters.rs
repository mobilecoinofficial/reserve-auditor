...
impl_get_and_inc! {
    ...
    num_invalid_ethereum_transactions inc_num_invalid_ethereum_transactions,
    num_invalid_multi_sig_transactions inc_num_invalid_multi_sig_transactions,
...
impl Counters {
    ...
    pub fn update_prometheus(&self) {
        ...
        prom_counters::NUM_INVALID_ETHEREUM_TRANSACTIONS
            .set(self.num_invalid_ethereum_transactions);

        prom_counters::NUM_INVALID_MULTI_SIG_TRANSACTIONS
            .set(self.num_invalid_multi_sig_transactions);
