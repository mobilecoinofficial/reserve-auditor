    ...
    GnosisSafeConfig {
        safes: vec![AuditedSafeConfig {
            ...
            AuditedToken {
                ...
                symbol: "TTO".to_string(),
                decimals: 9,
                eth_token_contract_addr: EthAddr::from_str("0x9306f1138deDa8202d9e3fb6B91eCa0bCc81E46F").unwrap(),
                logo_uri: "https://safe-transaction-assets.gnosis-safe.io/tokens/logos/0x50b347Ddbc73e45BD54683a57fcc28AA449Cf229.png".to_string(),
            ...
            AuditedToken {
                ...
                symbol: "TTO".to_string(),
                decimals: 9,
                eth_token_contract_addr: EthAddr::from_str("0x40354413F6557ac05a0ddfCDbee922cD6309c88c").unwrap(),
                logo_uri: "https://safe-transaction-assets.gnosis-safe.io/tokens/logos/0x50b347Ddbc73e45BD54683a57fcc28AA449Cf229.png".to_string(),
            ...
            AuditedToken {
                ...
                symbol: "TTO".to_string(),
                decimals: 9,
                eth_token_contract_addr: EthAddr::from_str("0x9F026f1a54658d8aBbd18618a0F7d2927fe88090").unwrap(),
                logo_uri: "https://safe-transaction-assets.gnosis-safe.io/tokens/logos/0x50b347Ddbc73e45BD54683a57fcc28AA449Cf229.png".to_string(),
