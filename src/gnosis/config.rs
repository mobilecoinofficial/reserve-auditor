...
pub struct AuditedToken {
    ...
    /// The shorthand symbol of the token
    pub symbol: String,

    /// The token's decimal precision
    pub decimals: u8,

    /// The location of the token's image as stored in the gnosis safe
    pub logo_uri: String,
                ...
                safes: vec![AuditedSafeConfig {
                    ...
                    tokens: vec![
                        AuditedToken {
                            ...
                            decimals: 9,
                            logo_uri: "https://safe-transaction-assets.gnosis-safe.io/tokens/logos/0xd92e713d051c37ebb2561803a3b5fbabc4962431.png".to_string(),
                        ...
                        AuditedToken {
                            ...
                            decimals: 9,
                            logo_uri: "https://safe-transaction-assets.gnosis-safe.io/tokens/logos/0x1111111111111111111111111111111111111111.png".to_string(),
                            aux_burn_contract_addr: EthAddr::from_str(
